...
setwd("~/research/repos/SpiderLearnerWorkflow/Figures/SupplementaryFigure7Figure8/")
source("../../Simulations/errorMetrics.R")

load("../../Results/SimC/clime/20221011_erHighPrec_RealData_n_100_p_50_simStudy.rda")
erHighPrecResults = theseResults
load("../../Results/SimC/clime/20221011_erLowPrec_RealData_n_100_p_50_simStudy.rda")
erLowPrecResults = theseResults
load("../../Results/SimC/clime/20221011_wsHighPrec_RealData_n_100_p_50_simStudy.rda")
wsHighPrecResults = theseResults
load("../../Results/SimC/clime/20221011_wsLowPrec_RealData_n_100_p_50_simStudy.rda")
wsLowPrecResults = theseResults
load("../../Results/SimC/clime/20221011_sfHighPrec_RealData_n_100_p_50_simStudy.rda")
sfHighPrecResults = theseResults
load("../../Results/SimC/clime/20221011_sfLowPrec_RealData_n_100_p_50_simStudy.rda")
sfLowPrecResults = theseResults
load("../../Results/SimC/clime/20221011_hsHighPrec_RealData_n_100_p_50_simStudy.rda")
hsHighPrecResults = theseResults
load("../../Results/SimC/clime/20221011_hsLowPrec_RealData_n_100_p_50_simStudy.rda")
...
write.table(round(t(weightsTable),2),file="../../Tables/weights_simC_clime.asv",sep="&",row.names=T,quote=F)
...
p<-ggplot(rfnLong, aes(x=method,y=`relative frobenius norm after`,color=method)) + 
  ...
  labs(x="Estimation Method", 
       ...
       title="Simulation C: n=100,p=50,q=1275",
       subtitle="Relative Frobenius Norm")

ggsave("../../Figures/SupplementaryFigure7Figure8/simC_rfnAfter_clime.jpeg", plot=p,width=10,height=10,units="in",dpi=150)
...
ggsave("../../Figures/SupplementaryFigure7Figure8/simC_mrv_clime.jpeg", plot=p,width=10,height=10,units="in",dpi=150)
...
ggsave("../../Figures/SupplementaryFigure7Figure8/simC_LLTrain_clime.jpeg", plot=p,width=10,height=10,units="in",dpi=150)
...
ggsave("../../Figures/SupplementaryFigure7Figure8/simC_LLTest_clime.jpeg", plot=p,width=10,height=10,units="in",dpi=150)
...
ggsave("../../Figures/SupplementaryFigure7Figure8/simC_bias_clime.jpeg", plot=p,width=15,height=8,units="in",dpi=150)
...
p=ggplot(RMSEDF, aes(x=method, y=meanRMSE, group=category,color=method)) + 
  ...
  ggtitle("Simulation C: Element-wise MSE")

ggsave("../../Figures/SupplementaryFigure7Figure8/simC_rmse_clime.jpeg", plot=p,width=15,height=8,units="in",dpi=150)
